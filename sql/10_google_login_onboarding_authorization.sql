...
BEGIN
    ...
    DECLARE @HasOnboardingInvitation BIT = 0;
    DECLARE @HasAthleteInvitation BIT = 0;
    DECLARE @HasAcceptedOnboarding BIT = 0;
    DECLARE @HasActiveRunnerAccess BIT = 0;
    DECLARE @AuthorizationState VARCHAR(30);
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            IF
            (
                @HasOnboardingInvitation = 0
                AND @HasAthleteInvitation = 0
            )
            BEGIN
                THROW 50025,
            ...
            (
                ...
                (
                    (
                        @HasOnboardingInvitation = 1
                        OR @HasAcceptedOnboarding = 1
                    )
                    AND @OnboardingCompletedAt IS NULL
                )
                BEGIN
                    IF @HasOnboardingInvitation = 1
                    BEGIN
                    ...
                    SET @AuthorizationState = 'ONBOARDING_REQUIRED';
                    ...
                    SELECT
                        ...
                        CAST(NULL AS INT) AS AthleteID,
                        CAST(NULL AS NVARCHAR(200)) AS FullName,
                        CAST('RUNNER' AS VARCHAR(20)) AS AccessRole;
        ...
        WHERE access_row.AppUserID = @AppUserID
          ...
          AND invitation.AthleteID IS NOT NULL
          AND
          (
